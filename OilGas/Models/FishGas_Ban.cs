namespace OilGas.Models
{
    ...
    public partial class FishGas_Ban
    {
        ...
        private FishGas_BasicData CBData
        {
            get
            {
                return FishGas_BasicData.GetAllFishGas_BasicData().Where(x => x.CaseNo == this.CaseNo).FirstOrDefault();
            }
        }
    }
}
