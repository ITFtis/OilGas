namespace OilGas.Models
{
    ...
    public partial class CarGas_Ban
    {
        ...
        public string TrueAddress
        {
            get
            {
                return string.IsNullOrWhiteSpace(this.Address) ? CGBData.Address : this.Address;
            }
        }
        ...
        private CarGas_BasicData CGBData
        {
            get
            {
                return CarGas_BasicData.GetAllCarGas_BasicData().Where(x => x.CaseNo == this.CaseNo).FirstOrDefault();
            }
        }
    }
}
