namespace OilGas.Models
{
    ...
    public partial class RP_Check_HiatusItem97_ByYearAndBusiOrgAndCity
    {
        ...
        public int? B03 { get; set; }

        public int? B04 { get; set; }

        public int? B05 { get; set; }

        public int? B06 { get; set; }

        public int? B07 { get; set; }

        public int? B08 { get; set; }

        public int? B09 { get; set; }
        ...
        public int? J01 { get; set; }

        public int? J02 { get; set; }

        public int? J03 { get; set; }

        public int? J04 { get; set; }

        public int? J05 { get; set; }

        public int? J06 { get; set; }

        public int? J07 { get; set; }

        public int? J08 { get; set; }

        public int? J09 { get; set; }

        public int? J10 { get; set; }

        public int? J11 { get; set; }

        public int? K01 { get; set; }

        public int? K02 { get; set; }

        public int? K03 { get; set; }

        public int? K04 { get; set; }
