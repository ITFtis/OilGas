namespace OilGas.Models.BASE
{
    ...
    public partial class Check_Item_SelfUp_BASE
    {
        [Key]
       ...
       SelectItemsClassNamespace = UsercitySelectItemsClassImp.AssemblyQualifiedName)]
        ...
        [StringLength(1)]
        [Display(Name = "槽體有無變形或銹蝕", Order = 1)]
        [Required]
        [ColumnDef(EditType = EditType.Radio, SelectItems = "{\"0\":\"未設置\",\"1\":\"良好\",\"2\":\"不良好\",\"3\":\"無法檢查\"}")]
        public string A01 { get; set; }

        [StringLength(1)]
        [Display(Name = "通風(排氣)管口無腐蝕、安全網無銹破、無阻塞", Order = 1)]
        [Required]
        [ColumnDef(EditType = EditType.Radio, SelectItems = "{\"0\":\"未設置\",\"1\":\"良好\",\"2\":\"不良好\",\"3\":\"無法檢查\"}")]
        public string A02 { get; set; }

        [StringLength(1)]
        [Display(Name = "排水閥設備無滲漏、操作靈活", Order = 1)]
        [Required]
        [ColumnDef(EditType = EditType.Radio, SelectItems = "{\"0\":\"未設置\",\"1\":\"良好\",\"2\":\"不良好\",\"3\":\"無法檢查\"}")]
        public string A03 { get; set; }

        [StringLength(1)]
        [Display(Name = "進出油管主閥操作靈活、管線無彎曲、滲漏", Order = 1)]
        [Required]
        [ColumnDef(EditType = EditType.Radio, SelectItems = "{\"0\":\"未設置\",\"1\":\"良好\",\"2\":\"不良好\",\"3\":\"無法檢查\"}")]
        public string A04 { get; set; }

        [StringLength(1)]
        [Display(Name = "可撓性金屬軟管無過度彎曲、滲漏、銹蝕", Order = 1)]
        [Required]
        [ColumnDef(EditType = EditType.Radio, SelectItems = "{\"0\":\"未設置\",\"1\":\"良好\",\"2\":\"不良好\",\"3\":\"無法檢查\"}")]
        public string A05 { get; set; }

        [StringLength(1)]
        [Display(Name = "油槽基礎無變位、沉陷、積水、龜裂", Order = 1)]
        [Required]
        [ColumnDef(EditType = EditType.Radio, SelectItems = "{\"0\":\"未設置\",\"1\":\"良好\",\"2\":\"不良好\",\"3\":\"無法檢查\"}")]
        ...
        [StringLength(1)]
        [Display(Name = "滅火車輪轉動靈活及橡皮管線纏繞正確", Order = 1)]
        [Required]
        [ColumnDef(EditType = EditType.Radio, SelectItems = "{\"0\":\"未設置\",\"1\":\"良好\",\"2\":\"不良好\",\"3\":\"無法檢查\"}")]
        public string C07 { get; set; }

        [StringLength(1)]
        [Display(Name = "氣瓶壓力足夠", Order = 1)]
        [Required]
        [ColumnDef(EditType = EditType.Radio, SelectItems = "{\"0\":\"未設置\",\"1\":\"良好\",\"2\":\"不良好\",\"3\":\"無法檢查\"}")]
        ...
        [StringLength(1)]
        [Display(Name = "油槽熔接接地電阻符合規定〔10Ω以下〕", Order = 1)]
        [Required]
        [ColumnDef(EditType = EditType.Radio, SelectItems = "{\"0\":\"未設置\",\"1\":\"良好\",\"2\":\"不良好\",\"3\":\"無法檢查\"}")]
        public string H03 { get; set; }

        [StringLength(10)]
        [Display(Name = "油槽熔接接地電阻符合規定〔10Ω以下〔50Ω以下〕實測", Order = 1)]
