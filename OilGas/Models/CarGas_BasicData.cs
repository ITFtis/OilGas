namespace OilGas.Models
{
    ...
    public partial class CarGas_BasicData: UsageStatebasic
    {
        ...
        //[StringLength(10)]
        //[ColumnDef(Visible = false, VisibleEdit = true)]
        //ublic string UsageState3 { get; set; }

        //[StringLength(10)]
        //[ColumnDef(Visible = false, VisibleEdit = true)]
        //blic string UsageState4 { get; set; }

        //[StringLength(10)]
        //[ColumnDef(Visible = false, VisibleEdit = true)]
        //ublic string UsageState5 { get; set; }

        //[StringLength(10)]
        //[ColumnDef(Visible = false, VisibleEdit = true)]
        //blic string UsageState6 { get; set; }

        //[StringLength(10)]
        //[ColumnDef(Visible = false, VisibleEdit = true)]
        //ublic string UsageState7 { get; set; }
