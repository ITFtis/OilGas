...
{
    /// <summary>
    /// 汽車加氣站/B統計報表專區/變更歷程-基本資料欄位清單
    /// </summary>
    public class Rpt_CarGas_BasicData_Log_List
    {
        static object lockGetAllDatas = new object();
        public static IEnumerable<CarGas_Log_1> GetAllDatas(int cachetimer = 0)
        {
            if (cachetimer == 0) cachetimer = Constant.cacheBigReportTime;

            string key = "OilGas.Rpt_CarGas_BasicData_Log_List";
            var allData = DouHelper.Misc.GetCache<IEnumerable<CarGas_Log_1>>(cachetimer, key);
            lock (lockGetAllDatas)
            {
                ...
                //if(true)
                {
                    ...
                    Dou.Models.DB.IModelEntity<CarGas_BasicData_Log> carGas_BasicData_Log = new Dou.Models.DB.ModelEntity<CarGas_BasicData_Log>(dbContext);
                    Dou.Models.DB.IModelEntity<CarGas_OilData_Log> carGas_OilData_Log = new Dou.Models.DB.ModelEntity<CarGas_OilData_Log>(dbContext);
                    Dou.Models.DB.IModelEntity<CarGas_Insurance_Log> carGas_Insurance_Log = new Dou.Models.DB.ModelEntity<CarGas_Insurance_Log>(dbContext);
                    Dou.Models.DB.IModelEntity<CarGas_Dispatch_Log> carGas_Dispatch_Log = new Dou.Models.DB.ModelEntity<CarGas_Dispatch_Log>(dbContext);
                    ...
                    var d1 = carGas_BasicData_Log.GetAll().GroupJoin(carGas_OilData_Log.GetAll(), a => a.CaseNo, b => b.CaseNo, (o, c) => new { o.CaseNo, o.Gas_Name, o.UsageState, o.ZipCode, o.Address, o.OperationDate, o.Recipient_date, o.Boss, o.TelNo, o.LicenseNo1, o.LicenseNo2, o.LicenseNo3, o.AddressNo, o.Report_date, o.SoilServerData, o.Business_theme, o.otherBusiness_theme, o.AncillaryFacility, o.LandPriority, o.Land_acreage, o.LandClass, o.OtherLandClass, o.LandUsageZone, o.OtherLandUsageZone, o.Facility, o.Island, o.Mod_date,
                                        o.one_gun, o.two_gun, o.four_gun, o.six_gun, o.eight_gun, o.Tank, c })
                                    .SelectMany(b => b.c.DefaultIfEmpty(), (o, c) => new {
                                        o.CaseNo, o.Gas_Name, o.UsageState, o.ZipCode, o.Address, o.OperationDate, o.Recipient_date, o.Boss, o.TelNo, o.LicenseNo1, o.LicenseNo2, o.LicenseNo3, o.AddressNo, o.Report_date, SoilServerData = o.SoilServerData.Trim(), o.Business_theme, o.otherBusiness_theme, AncillaryFacility = o.AncillaryFacility.Trim(), o.LandPriority, o.Land_acreage, o.LandClass, o.OtherLandClass, o.LandUsageZone, o.OtherLandUsageZone, Facility = o.Facility.Trim(), o.Island, o.Mod_date,
                                        o.one_gun, o.two_gun, o.four_gun, o.six_gun, o.eight_gun, o.Tank, c.Tank_type_tank, c.Tank_type_tank_seat, SaleSoilClass = c.SaleSoilClass.Trim(), c.Tank_place_type
                                    })
                                    //.Where(a => a.案件編號 != null && a.案件編號 != "")
                                    //.Where(a => a.CaseNo == "G084070001")  /////////////
                                    .Distinct().ToList();

                    //carGas_Dispatch_Log
                    var m1 = carGas_Dispatch_Log.GetAll().Select(o => new
                    {
                        o.CaseNo, o.DispatchClass,o.Dispatch_date
                    });

                    //carGas_Insurance_Log
                    var d2 = carGas_Insurance_Log.GetAll().GroupJoin(carVehicleGas_InsuranceCompanyName.GetAll(), a=> a.Insurance_Company, b=>b.Value, (o, c) => new
                    {
                    ...
                    allData =  d1.GroupJoin(m1, a => a.CaseNo, b => b.CaseNo, (o, c) => new { o.CaseNo, o.Gas_Name, o.UsageState, o.ZipCode, o.Address, o.OperationDate, o.Recipient_date, o.Boss, o.TelNo, o.LicenseNo1, o.LicenseNo2, o.LicenseNo3, o.AddressNo, o.Report_date, o.SoilServerData, o.Business_theme, o.otherBusiness_theme, o.AncillaryFacility, o.LandPriority, o.Land_acreage, o.LandClass, o.OtherLandClass, o.LandUsageZone, o.OtherLandUsageZone, o.Facility, o.Island, o.Mod_date,  
                                ...
                                .GroupJoin(d3, a => a.UsageState, b => b.Value, (o, c) => new { o.CaseNo, o.Gas_Name, o.UsageState, o.ZipCode, o.Address, o.OperationDate, o.Recipient_date, o.Boss, o.TelNo, o.LicenseNo1, o.LicenseNo2, o.LicenseNo3, o.AddressNo, o.Report_date, o.SoilServerData, o.Business_theme, o.otherBusiness_theme, o.AncillaryFacility, o.LandPriority, o.Land_acreage, o.LandClass, o.OtherLandClass, o.LandUsageZone, o.OtherLandUsageZone, o.Facility, o.Island, o.Mod_date, o.DispatchClass, o.Dispatch_date, 
                                    o.one_gun, o.two_gun, o.four_gun, o.six_gun, o.eight_gun, o.Tank, o.Tank_type_tank, o.Tank_type_tank_seat, o.SaleSoilClass, o.Tank_place_type, o.CompanyName, o.Insurance_Company, o.Insurance_otherCompany, o.Insurance_No, o.Insurance_policy_start, o.Insurance_policy_end, o.Insurance_Type,
                                ...
                                .GroupJoin(d4, a => a.Business_theme, b => b.Value, (o, c) => new { o.CaseNo, o.Gas_Name, o.UsageState, o.ZipCode, o.Address, o.OperationDate, o.Recipient_date, o.Boss, o.TelNo, o.LicenseNo1, o.LicenseNo2, o.LicenseNo3, o.AddressNo, o.Report_date, o.SoilServerData, o.Business_theme, o.otherBusiness_theme, o.AncillaryFacility, o.LandPriority, o.Land_acreage, o.LandClass, o.OtherLandClass, o.LandUsageZone, o.OtherLandUsageZone, o.Facility, o.Island, o.Mod_date, o.DispatchClass, o.Dispatch_date, 
                                    o.one_gun, o.two_gun, o.four_gun, o.six_gun, o.eight_gun, o.Tank, o.Tank_type_tank, o.Tank_type_tank_seat, o.SaleSoilClass, o.Tank_place_type, o.CompanyName, o.Insurance_Company, o.Insurance_otherCompany, o.Insurance_No, o.Insurance_policy_start, o.Insurance_policy_end, o.Insurance_Type,o.Type, o.ShortName,
                                ...
                                .GroupJoin(d5, a => a.LandClass, b => b.Value, (o, c) => new { o.CaseNo, o.Gas_Name, o.UsageState, o.ZipCode, o.Address, o.OperationDate, o.Recipient_date, o.Boss, o.TelNo, o.LicenseNo1, o.LicenseNo2, o.LicenseNo3, o.AddressNo, o.Report_date, o.SoilServerData, o.Business_theme, o.otherBusiness_theme, o.AncillaryFacility, o.LandPriority, o.Land_acreage, o.LandClass, o.OtherLandClass, o.LandUsageZone, o.OtherLandUsageZone, o.Facility, o.Island, o.Mod_date, o.DispatchClass, o.Dispatch_date, 
                                    o.one_gun, o.two_gun, o.four_gun, o.six_gun, o.eight_gun, o.Tank, o.Tank_type_tank, o.Tank_type_tank_seat, o.SaleSoilClass, o.Tank_place_type, o.CompanyName, o.Insurance_Company, o.Insurance_otherCompany, o.Insurance_No, o.Insurance_policy_start, o.Insurance_policy_end, o.Insurance_Type, o.Type, o.ShortName, o.bus_name,                                    
                    ...
                    foreach (var data in allData)
                    {
                        ...
                        //加油泵島數
                        data.加油泵島數 = data.加油泵島數 == null ? null : data.加油泵島數;
