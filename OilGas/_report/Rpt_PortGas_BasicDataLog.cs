...
{
    /// <summary>
    /// 航港自用加儲油/E統計報表專區/變更歷程資料匯出
    /// </summary>
    public class Rpt_PortGas_BasicDataLog
    {
        static object lockGetAllDatas = new object();
        public static IEnumerable<PortGas_Log_1> GetAllDatas(int cachetimer = 0)
        {
            if (cachetimer == 0) cachetimer = Constant.cacheReportTime;

            string key = "OilGas.Rpt_PortGas_BasicDataLog";
            var allData = DouHelper.Misc.GetCache<IEnumerable<PortGas_Log_1>>(cachetimer, key);
            lock (lockGetAllDatas)
            {
                ...
                //if(true)
                {
                    ...
                    Dou.Models.DB.IModelEntity<PortGas_BasicData_Log> portGas_BasicData_Log = new Dou.Models.DB.ModelEntity<PortGas_BasicData_Log>(dbContext);
                    ...
                    Dou.Models.DB.IModelEntity<PortGas_Insurance_Log> portGas_Insurance_Log = new Dou.Models.DB.ModelEntity<PortGas_Insurance_Log>(dbContext);
                    ...
                    var d1 = portGas_BasicData_Log.GetAll().Select(o => new
                    {
                        o.ID, o.CaseNo, o.LocationType, o.Location, o.Gas_Name, o.Gas_Location, o.Change, o.ApparatusOwner, o.UsageState, o.UsageState1, o.UsageState2, o.UsageState3, o.UsageState4, o.Recipient_date, StartDate = o.Report_date, EndDate = o.StopReport_date, o.LicenseNo1, o.LicenseNo2, o.Boss, o.Boss_Tel, o.Boss_Email, o.BasicFacilities, o.OtherFacilities, o.SupplyTarget, o.Mod_date }
                    ).Distinct().ToList();

                    var d2 = portGas_UsageState.GetAll().Select(o => new
                    {
                        o.UsageState_TypeID, o.UsageState_TypeName
                    });

                    var d3 = portGas_Insurance_Log.GetAll().GroupJoin(carVehicleGas_InsuranceCompanyName.GetAll(), a=> a.Insurance_Company, b=>b.Value, (o, c) => new
                    {                        
                        o.CaseNo, o.Change, 
                    ...
                    allData = d1.GroupJoin(d2, a => a.UsageState, b => b.UsageState_TypeID, (o, c) => new { o.ID, o.CaseNo, o.LocationType, o.Location, o.Gas_Name, o.Gas_Location, o.Change, o.ApparatusOwner, o.UsageState, o.UsageState1, o.UsageState2, o.UsageState3, o.UsageState4, o.Recipient_date, o.StartDate, o.EndDate, o.LicenseNo1, o.LicenseNo2, o.Boss, o.Boss_Tel, o.Boss_Email, o.BasicFacilities, o.OtherFacilities, o.SupplyTarget, o.Mod_date,
                                    UsageStateName = c.FirstOrDefault() == null ? "" : c.FirstOrDefault().UsageState_TypeName})
                                .GroupJoin(d2, a => a.UsageState1, b => b.UsageState_TypeID, (o, c) => new { o.ID, o.CaseNo, o.LocationType, o.Location, o.Gas_Name, o.Gas_Location, o.Change, o.ApparatusOwner, o.UsageState, o.UsageState1, o.UsageState2, o.UsageState3, o.UsageState4, o.UsageStateName, o.Recipient_date, o.StartDate, o.EndDate, o.LicenseNo1, o.LicenseNo2, o.Boss, o.Boss_Tel, o.Boss_Email, o.BasicFacilities, o.OtherFacilities, o.SupplyTarget, o.Mod_date,
                                    UsageStateName1 = c.FirstOrDefault() == null ? "" : c.FirstOrDefault().UsageState_TypeName})
                                .GroupJoin(d2, a => a.UsageState2, b => b.UsageState_TypeID, (o, c) => new { o.ID, o.CaseNo, o.LocationType, o.Location, o.Gas_Name, o.Gas_Location, o.Change, o.ApparatusOwner, o.UsageState, o.UsageState1, o.UsageState2, o.UsageState3, o.UsageState4, o.UsageStateName, o.UsageStateName1, o.Recipient_date, o.StartDate, o.EndDate, o.LicenseNo1, o.LicenseNo2, o.Boss, o.Boss_Tel, o.Boss_Email, o.BasicFacilities, o.OtherFacilities, o.SupplyTarget, o.Mod_date,
                                    UsageStateName2 = c.FirstOrDefault() == null ? "" : c.FirstOrDefault().UsageState_TypeName})
                                .GroupJoin(d2, a => a.UsageState3, b => b.UsageState_TypeID, (o, c) => new { o.ID, o.CaseNo, o.LocationType, o.Location, o.Gas_Name, o.Gas_Location, o.Change, o.ApparatusOwner, o.UsageState, o.UsageState1, o.UsageState2, o.UsageState3, o.UsageState4, o.UsageStateName, o.UsageStateName1, o.UsageStateName2, o.Recipient_date, o.StartDate, o.EndDate, o.LicenseNo1, o.LicenseNo2, o.Boss, o.Boss_Tel, o.Boss_Email, o.BasicFacilities, o.OtherFacilities, o.SupplyTarget, o.Mod_date,
                                    UsageStateName3 = c.FirstOrDefault() == null ? "" : c.FirstOrDefault().UsageState_TypeName})
                                .GroupJoin(d2, a => a.UsageState4, b => b.UsageState_TypeID, (o, c) => new { o.ID, o.CaseNo, o.LocationType, o.Location, o.Gas_Name, o.Gas_Location, o.Change, o.ApparatusOwner, o.UsageState, o.UsageState1, o.UsageState2, o.UsageState3, o.UsageState4, o.UsageStateName, o.UsageStateName1, o.UsageStateName2, o.UsageStateName3, o.Recipient_date, o.StartDate, o.EndDate, o.LicenseNo1, o.LicenseNo2, o.Boss, o.Boss_Tel, o.Boss_Email, o.BasicFacilities, o.OtherFacilities, o.SupplyTarget, o.Mod_date,
                                    UsageStateName4 = c.FirstOrDefault() == null ? "" : c.FirstOrDefault().UsageState_TypeName})
                                .GroupJoin(d3, 
                                    a => new { a.CaseNo, a.Change },
                                    b => new { b.CaseNo, b.Change }, (o, c) => new { o.ID, o.CaseNo, o.LocationType, o.Location, o.Gas_Name, o.Gas_Location, o.Change, o.ApparatusOwner, o.UsageState, o.UsageState1, o.UsageState2, o.UsageState3, o.UsageState4, o.UsageStateName, o.UsageStateName1, o.UsageStateName2, o.UsageStateName3, o.Recipient_date, o.StartDate, o.EndDate, o.LicenseNo1, o.LicenseNo2, o.Boss, o.Boss_Tel, o.Boss_Email, o.BasicFacilities, o.OtherFacilities, o.SupplyTarget, o.Mod_date, o.UsageStateName4, c})
                                .SelectMany(b => b.c.DefaultIfEmpty(), (o, c) => new {                                    
                                    ...
                                    InsuranceCompanyName = c == null ? "" : c.InsuranceCompanyName
                                })

                            .Select(o => new PortGas_Log_1
                            {
                                ID = o.ID,
                                案件編號 = o.CaseNo,
