$(document).ready(function () {
    ...
    a.callback = function ExportExcel(evt) {
        ...
        $.ajax({
            url: app.siteRoot + 'Audit_CounselingReportMissing2/ExportAudit_CounselingReportMissing2',
            datatype: "json",
            type: "POST",
            data: { paras: [paras] },
    ...
    function getChart() {
        $.ajax({
            type: "POST",
            url: $.AppConfigOptions.baseurl + "Audit_CounselingReportMissing2/GetChartData",
