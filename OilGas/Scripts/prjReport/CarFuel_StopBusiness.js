$(document).ready(function () {
    ...
    a.callback = function ExportExcel(evt) {
        ...
        $.ajax({
            url: app.siteRoot + 'CarFuel_StopBusiness/ExportCarFuel_StopBusiness',
            datatype: "json",
            type: "POST",
            data: { paras: [paras] },
    ...
    function getChart() {
        $.ajax({
            type: "POST",
            url: $.AppConfigOptions.baseurl + "CarFuel_StopBusiness/GetChartData",
    ...
    function InsertTotalAfterSorted() {
        ...
        $.ajax({
            dataType: 'json',
            url: $.AppConfigOptions.baseurl + 'CarFuel_StopBusiness/GetSumData',
            type: "post",
    ...
    $('#_table').on('click', 'td', function () {
        ...
        $("#titledetail").text(rowData[0] + years + "年度" + workTypeCN + "之加油站清單")
        $("#ITPopUp").modal('show');
        ...
        console.log(fd);
        $.ajax({
            url: app.siteRoot + 'CarFuel_StopBusiness/GetDetailTableData',
            datatype: "json",
            type: "POST",
            //data: { paras: [paras] },
            data: fd,
...
function ExportDetailExcel() {
    ...
    $.ajax({
        url: app.siteRoot + 'CarFuel_StopBusiness/ExportCarFuel_workBusinessDesc',
        datatype: "json",
        type: "POST",
        //data: { paras: [paras] },
        data: fd,
