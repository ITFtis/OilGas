...
namespace OilGas.Controllers.CarGas
{
    ...
    public class CarGas_GrowController : Controller
    {
        ...
        /// <returns></returns>
        public ActionResult ExportCarGas_Grow(ReportData.ViewParams objs)
        {
            string error = "";
            string url = "";
            string folder = FileHelper.GetFileFolder(Code.TempUploadFile.汽車加氣站_B統計報表專區_加氣站成長分析報表);
            string fileTitle = "汽車加氣站_加氣站成長分析報表";
