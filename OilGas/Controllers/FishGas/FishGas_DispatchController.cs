...
{
    [MenuDef(Id = "FishGas_Dispatch", Name = "漁船加油站發文歷程", MenuPath = "隱藏選單/漁船加油站基本資料", Action = "Index", Index = 0, Func = FuncEnum.ALL, AllowAnonymous = false)]
    public class FishGas_DispatchController : APaginationModelController<FishGas_Dispatch>
    {
        ...
        protected override IModelEntity<FishGas_Dispatch> GetModelEntity()
        {
            return new ModelEntity<FishGas_Dispatch>(new OilGasModelContextExt());
        }
        protected override IQueryable<FishGas_Dispatch> BeforeIQueryToPagedList(IQueryable<FishGas_Dispatch> iquery, params KeyValueParams[] paras)
        {
        ...
        protected override void UpdateDBObject(IModelEntity<FishGas_Dispatch> dbEntity, IEnumerable<FishGas_Dispatch> objs)
        {
            ...
            var selectobjs = db.FishGas_Dispatch.Where(X => X.ID == ID).FirstOrDefault();
        ...
        protected override void AddDBObject(IModelEntity<FishGas_Dispatch> dbEntity, IEnumerable<FishGas_Dispatch> objs)
        {
        ...
        protected override void DeleteDBObject(IModelEntity<FishGas_Dispatch> dbEntity, IEnumerable<FishGas_Dispatch> objs)
        {
            basic.iscityedit(objs.First().CaseNo);//確定縣市跟帳號縣市相同
            ...
            else
            {
                ...
                System.IO.File.Delete(path + @"FishGas\Dispatch\" + objs.First().File_name);//刪除舊檔案
            }
        ...
        {
            //先抓原本資料的File_name
            var selectobjs = (from a in db.FishGas_Dispatch
            ...
            //上傳檔案，並拿檔名
            var filename = basic.upload(file, Old_File_name, "FishGas\\Dispatch");
