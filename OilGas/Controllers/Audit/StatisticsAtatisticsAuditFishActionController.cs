...
{
    [Dou.Misc.Attr.MenuDef(Id = "StatisticsAtatisticsAuditFishAction", Name = "漁船加油站複查統計", MenuPath = "隱藏選單/新增複查結果", Action = "Index", Index = 1, Func = Dou.Misc.Attr.FuncEnum.None, AllowAnonymous = false)]
    public class StatisticsAtatisticsAuditFishActionController : APaginationModelController<Check_Item_Fish_Action>
    {
