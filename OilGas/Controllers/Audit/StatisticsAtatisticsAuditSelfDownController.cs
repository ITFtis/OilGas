...
{
    [Dou.Misc.Attr.MenuDef(Id = "StatisticsAtatisticsAuditSelfDown", Name = "地下自用加儲油查核統計", MenuPath = "隱藏選單/新增查核結果", Action = "Index", Index = 1, Func = Dou.Misc.Attr.FuncEnum.None, AllowAnonymous = false)]
    public class StatisticsAtatisticsAuditSelfDownController : APaginationModelController<Check_Item_SelfDown>
    {
