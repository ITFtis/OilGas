...
{
    [Dou.Misc.Attr.MenuDef(Id = "StatisticsAtatisticsAuditCarFuel", Name = "加油站查核統計", MenuPath = "隱藏選單/新增查核結果", Action = "Index", Index = 1, Func = Dou.Misc.Attr.FuncEnum.None, AllowAnonymous = false)]
    public class StatisticsAtatisticsAuditCarFuelController : APaginationModelController<Check_Item>
    {
